...
export default async function Home() {
  return (
    <div className="container mx-auto font-mono">
      ...
      <h1>各サイトの全てのファイルがInternetArchiveに保存されているのか？</h1>
      <p>トップページからリンクされていない孤立ファイルは見つけようがないので恐らく抜けはそれなりにある。</p>
      <p>HPスペース全体としての容量が5MBなので、容量オーバーで保存されなかった事は無い気がする。</p>
      <p>wgetを使って各サイトのファイル一覧を作成して、InternetArchiveに保存されていないファイルを登録する事も可能ではあるが、そこまではいいかなって。</p>
      <p>各HPが最大5MB、全部で約6000サイトだから全部DLしても約30GB。全然無茶な値ではない。全部のサイトが最大容量使ってる訳もないし。</p>
    </div>
  );
}
